...
static CGFloat kFacebookBlue[4] = {0.42578125f, 0.515625f, 0.703125f, 1.0f};
static CGFloat kBorderGray[4] = {0.3f, 0.3f, 0.3f, 0.8f};
static CGFloat kBorderBlack[4] = {0.3f, 0.3f, 0.3f, 1.0f};
static CGFloat kBorderBlue[4] = {0.23f, 0.35f, 0.6f, 1.0f};

static CGFloat kTransitionDuration = 0.3f;

static CGFloat kTitleMarginX = 8.0f;
static CGFloat kTitleMarginY = 4.0f;
static CGFloat kPadding = 2.0f;//10.0f;
static CGFloat kBorderWidth = 4.0f;//10.0f;
...
- (void)strokeLines:(CGRect)rect stroke:(const CGFloat*)strokeColor {
...

  {
    ...
    CGContextStrokeLineSegments(context, points, 2.0f);
  }
  {
...
- (void)sizeToFitOrientation:(BOOL)transform {
  ...
  CGFloat width = floor(scale_factor * frame.size.width) - kPadding * 2.0f;
  CGFloat height = floor(scale_factor * frame.size.height) - kPadding * 2.0f;
...
- (id)init {
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    UIColor* color = [UIColor colorWithRed:167.0f/255 green:184.0f/255 blue:216.0f/255 alpha:1.0f];
